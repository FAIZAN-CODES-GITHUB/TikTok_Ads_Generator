...
class TikTokAdAgent:
    ...
    def _initialize_oauth(self):
        ...
        try:
            ...
            print(f"OAuth initialization warning: {e}")
    ...
    def _handle_finalization(self) -> str:
        ...
        if not is_valid:
            ...
            return (
                f"⚠️ Cannot able to proceed - some fields are invalid:\n\n"
                f"{error_message}\n\n"
...
Reply with:
  • "submit" or to create the campaign
...
We'll need to collect:
  • Name of Campaign
  • Objective of Campaign (Traffic or Conversions)
  • Ad text (max 100 characters)
  • Call-to-action (CTA)
  • Music 

**Ready for starting campaign?** 

Give the Campaign Name to begin!
"""