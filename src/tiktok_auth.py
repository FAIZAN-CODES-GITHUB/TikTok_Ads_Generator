...
class TikTokOAuth:
    ...
    def refresh_token_if_needed(self) -> bool:
        ...
        if self.current_token.is_expired():
            print("🔄 Token has been expired. Re-authenticating...")
        ...
        if time_left < 300:  # Less than 5 minutes
            print(f"⚠️ Token going to expires soon ({time_left}s remaining). Consider to be refresh.")
