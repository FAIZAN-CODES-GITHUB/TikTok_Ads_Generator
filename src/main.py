...
╔══════════════════════════════════════════════════════╗
║                                                      ║
║   🎯 TikTok AI Ad Agent (Campaign Ad Generator  🎯  ║
║                                                      ║
...
def main():
    ...
    try:
        ...
        console.print(Panel(greeting, title="[bold white]Agent[/bold white]", border_style="white"))
...
"""
                        console.print(Panel(review, title="Campaign Review", border_style="red"))
                    else:
                ...
                if user_input.lower().startswith('upload '):
                    ...
                    if file_name:
                        ...
                        console.print(Panel(response, title="[bold white]Agent[/bold white]", border_style="white"))
                    else:
